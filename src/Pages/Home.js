...
const Home = () => {
  ...
  return (
    <>
      <main className='py-1 mt-3'>
       <div className="container shadow-lg">
        <div className="text-center">
          <h2 className='mb-5 py-3'>
            ...
            return(
              ...
              <div className="card">
                <div className="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                  <img src={`http://localhost:8000/${item.thumbnail}`} className='img-fluid' alt="" />
                  <a href="#!">
                ...
                <div className="card-body">
                  ...
                  <Link to={`/blog/${item._id}`} className=" btn btn-warning">Read More</Link>
                </div>
              </div>
            </div>
            )
