  ...
  return (
    <>
     <div className="container shadow mt-5">
        ...
        <div className="col-xl-12 py-3 d-flex items-center justify-content-center">
            <div className="row">
                <form onSubmit={handSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className='form-control' name='description' placeholder='Blog Description' value={input.description} onChange={(e)=>setInput({...input,[e.target.name]:e.target.value})}>

                        </textarea>
                    </div>
                    <div className="mb-3">
                    <label htmlFor="formGroupExampleInput" className='form-label'>Thumbnail</label>
                    <input type="file" name='thumbnail' onChange={(e)=>setFile(e.target.files[0])} className='form-control' id='formGroupExampleInput' placeholder='Select Thumbnail' />
                    </div>
                    <div className="mb-3">
